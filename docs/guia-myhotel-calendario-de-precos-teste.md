---
sidebar_label: TÍTULO PRINCIPAL DA ETAPA 3
title: TÍTULO PRINCIPAL DA ETAPA 3
description: Guia completo de tarifas e disponibilidade.
slug: /
---

# Guia completo de tarifas e disponibilidade
...
Este guia apresenta informações detalhadas sobre tarifas, disponibilidade, restrições e funcionalidades do calendário de preços.
...
Ao estacionar o mouse sobre um dia do calendário, aparecerá também o botão **'Editar'** (sinalizado por um ícone em formato de lápis no canto superior direito do quadrado do dia). Será possível clicar em **'Editar'**, **'Fechar este(s) dia(s)'** e **'Abrir este(s) dia(s)'**:
...
**Nota:** Todos os placeholders de imagens foram preservados exatamente como aparecem no HTML de entrada, incluindo seus números.