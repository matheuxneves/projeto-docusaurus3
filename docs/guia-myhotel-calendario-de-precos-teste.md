...
description: Guia rápido para entender o calendário de preços e funcionalidades de tarifas e disponibilidade.
slug: /
---
...
Após selecionar o "tipo de quarto" do tarifário que deseja consultar, é importante que você conheça as opções de

**'pesquisa e os filtros'**

disponíveis, que podem ajudar a encontrar as informações desejadas de maneira mais rápida. Veja:
...
<div class="image" style="left:98.0px;top:4.0px;z-index:117;transform:rotate(0deg);"></div>
<div class="image" style="left:93.0px;top:244.0px;z-index:124;transform:rotate(0deg);"></div>
<div class="image" style="left:347.0px;top:359.0px;z-index:127;transform:rotate(0deg);"></div>
<div class="vector" style="left:97.0px;top:177.0px;transform:rotate(0deg);"></div>
