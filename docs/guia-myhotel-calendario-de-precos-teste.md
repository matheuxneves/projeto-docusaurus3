...
description: Guia completo sobre tarifas, disponibilidade e funcionalidades do calendário de preços.
slug: /
---
...
Para acessar o calendário de preços do hotel, siga o menu de navegação > Gestão > Tarifários e Disponibilidade > Calendário de Preços:  
...
Para selecionar o tipo de quarto, clique na opção correspondente. Você poderá visualizar os preços, restrições e fechamentos de vendas aplicados para os canais de venda atribuídos aos tarifários criados pelo hotel.  

Para visualizar essas informações, é necessário selecionar um ‘tipo de quarto’ do tarifário desejado.  

#### Opções disponíveis:

- **Pesquisa e filtros:** que ajudam a encontrar as informações desejadas de forma rápida. Veja:  
...
#### PESQUISAR E AGRUPAR POR:

Será possível buscar pelo nome do ‘Tarifário’, do ‘Tipo de Quarto’, pelo nome do ‘Canal’ de vendas e pelo nome do ‘Nível de Fidelização’ (caso o hotel tenha ativado a solução BeeLoyalty).  
...
Será possível ‘Editar’ as informações do tarifário ou do tipo de quarto para seguir com as atualizações de:  

- **Preços do Quarto:** aqui também será possível fazer atualizações de preços por ‘Preço Fixo’ ou ‘Variação de Preço’.  

- Para tarifários com o ‘Tipo de Disponibilidade: Tarifário ou Tarifário com impacto no inventário’, além de atualizar o preço, também será possível atualizar o ‘allotment’.  
...
- Ao clicar no botão ‘Editar’ (sinalizado com ícone de lápis) no canto superior direito da janela de informações, aparecerão mais opções:  
...
Ao estacionar o mouse neste botão, será exibida uma legenda com as cores relacionadas à disponibilidade do hotel — ‘Aberto para Vendas’, ‘Fechado para Vendas’, ‘Fechado Parcialmente para Vendas’ e ‘Allotment Indisponível’.  
...
Informando os extras, as taxas, as ofertas e os canais atribuídos ao tarifário.  

Após a atualização, clique em ‘Salvar’.  
...
Ao passar o mouse sobre um dia do calendário, aparecerá também o botão ‘Editar’ (sinalizado por um ícone de lápis) no canto superior direito do quadrado do dia. E será possível clicar em ‘Editar’, ‘Fechar este(s) dia(s)’ e ‘Abrir este(s) dia(s)’:
...
‘Fechar este(s) dia(s)’ e ‘Abrir este(s) dia(s)’ para um período,  

basta clicar sobre o dia inicial e arrastar para os demais dias do período.  

Depois, clique no botão ‘Editar’ (sinalizado pelo ícone de ‘Lápis’), do último dia do período selecionado.  
...
*(Nenhum conteúdo adicional de histórico foi fornecido)*